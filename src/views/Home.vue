<template>
  <section class="home">
    <Top msg="E-Wallet"/>
    <Card :cardNumber="activeCard.cardNumber" :fullName="activeCard.fullName" :validThru="activeCard.validThru" :bankName="activeCard.bankName" :cardColor="activeCard.cardColor"/>
